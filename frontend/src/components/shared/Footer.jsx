...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-8 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="hover:text-gray-300 transform hover:scale-110 transition duration-300" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-gray-300 transform hover:scale-110 transition duration-300" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-gray-300 transform hover:scale-110 transition duration-300" aria-label="LinkedIn">
